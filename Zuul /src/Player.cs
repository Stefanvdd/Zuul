   ...
   public bool TakeFromChest(string itemName)
{
    ...
    {
        // Check if the item is "cash" and if the player has it in their backpack
        if (itemName.ToLower() == "mercedes_c63s_amg" && !backpack.GetItems().ContainsKey("cash"))
        {
            Console.WriteLine("You need cash to purchase the Mercedes C63S AMG.");
            return false;
        }
          if (itemName.ToLower() == "mercedes_g43_amg" && !backpack.GetItems().ContainsKey("cash"))
        {
            Console.WriteLine("You need cash to purchase the Mercedes G43 AMG.");
            return false;
        }
          if (itemName.ToLower() == "mercedes_c350e" && !backpack.GetItems().ContainsKey("cash"))
        {
            Console.WriteLine("You need cash to purchase the Mercedes C350E.");
            return false;
        }
          if (itemName.ToLower() == "mercedes_brabus_800" && !backpack.GetItems().ContainsKey("cash"))
        {
            Console.WriteLine("You need cash to purchase the Mercedes BRABUS 800.");
            return false;
        }
